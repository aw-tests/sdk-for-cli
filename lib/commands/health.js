...
const healthGetQueueBuilds = async ({ parseOutput = true, sdk = undefined}) => {
...
const healthGetQueueDatabases = async ({ name, parseOutput = true, sdk = undefined}) => {
    /* @param {string} name */
...
const healthGetQueueDeletes = async ({ parseOutput = true, sdk = undefined}) => {
...
const healthGetQueueMails = async ({ parseOutput = true, sdk = undefined}) => {
...
const healthGetQueueMessaging = async ({ parseOutput = true, sdk = undefined}) => {
...
const healthGetQueueMigrations = async ({ parseOutput = true, sdk = undefined}) => {
